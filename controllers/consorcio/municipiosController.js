...
module.exports = {
    ...
    newCounty(req, res) {
        ...
        const arms = req.files[0]?.filename ? `${process.env.BASE_URL}/api-consorcio-residuos/uploads/brasoes/${req.files[0]?.filename}` : '';
    ...
    updateCounty(req, res) {
        ...
        const arms = req.files[0]?.filename ? `${process.env.BASE_URL}/api-consorcio-residuos/uploads/brasoes/${req.files[0]?.filename}` : dataForm.arms;
        const name = dataForm.name;
        const foundation = dataForm.foundation || '';
        const politicalEmancipation = dataForm.politicalEmancipation || '';
        const gentile = dataForm.gentile || '';
