...
module.exports = {
    ...
    newTransparency(req, res) {
        ...
        const newTransparency = `INSERT INTO transparencyConsorcio(
        title,
        subTitle,
        description, 
        section1,
    ...
    getTransparency(req, res) {
        const selectTransparency = `SELECT * FROM transparencyConsorcio`;
    ...
    updateTransparency(req, res) {
        ...
        const updateRoles = 'UPDATE `transparencyConsorcio` SET `title`= ?,' +
            '`subTitle`= ?,' +
            '`description`= ?,' +
            '`section1`= ?,' +
            '`section2`= ?,' +
            ...
            '`section4`= ?,' +
            '`section5`= ?' +
            'WHERE `transparencyConsorcio`.`ID`= ?';
