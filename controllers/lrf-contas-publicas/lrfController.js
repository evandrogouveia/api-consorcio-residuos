...
module.exports = {
    ...
    newLrf(req, res) {
        ...
        const file = req.files[0]?.filename ? `${process.env.BASE_URL}/api-consorcio-residuos/uploads/lrf/${req.files[0]?.filename}` : '';
    ...
    updateLrf(req, res) {
        ...
        const secretary = dataForm.secretary || '';
        const competence = dataForm.competence || '';
        const file = req.files[0]?.filename ? `${process.env.BASE_URL}/api-consorcio-residuos/uploads/lrf/${req.files[0]?.filename}` : dataForm.file;
        const description = dataForm.description || '';
        const acronym = dataForm.acronym || '';
